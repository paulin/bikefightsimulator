...
| [Data Science Playground](datascience/) | An interactive sandbox for rebuilding intuition about ML algorithms. Manipulate the data and hyperparameters and watch the internals update live. Phase 1 is built (Linear Regression, KNN, Decision Tree, K-Means, PCA); the rest of the spec roadmap is listed in-app. |
